...
/**
 * MADE BY GEOKURELI THE LEGENED GOD HERO MVP -ninjamuffin99
 * Yes Cam GeoKureli IS a legend -Bogdan2D
 */
class NGio
{
	...
	inline static public function unlockMedal(id:Int)
	{
		if (isLoggedIn)
		{
			...
			if (!medal.unlocked)
			{
				PlayState.isMedalLocked = true;
				medal.sendUnlock();
			}
			else
				PlayState.isMedalLocked = false;
		}
	}
}
